...
find original:https://app.codesignal.com/arcade/code-arcade/spring-of-integration/PSeEALZTxd93zBHS7

=end

def beautiful_text(str, l, r)
  (l..r).each do |i|
    var = 0
    loop do
      var += i
      return true if var == str.size
      break if var > str.size || str[var] != ' '
      var += 1
    end
  end
  false
