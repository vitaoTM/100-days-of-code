...
image at:
  ref_imgs/volleybal_positions.png
...
find original: https://app.codesignal.com/arcade/code-arcade/list-backwoods/fmYdsYcGfaTu4yTQt/
...
def volleyball_positions(f, k)
  (k%6).times do
    ...
    f[2][1], f[3][2], f[1][2], f[0][1], f[1][0], f[3][0]
  end
  f
end
