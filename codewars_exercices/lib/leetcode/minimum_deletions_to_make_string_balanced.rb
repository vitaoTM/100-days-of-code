...
find original: https://leetcode.com/problems/minimum-deletions-to-make-string-balanced/description/

=end

def minimum_deletions(s)
  count_a = s.chars.count('a')
  count_b = 0
  result = count_a
  ...
  s.each_char do |c|
    ...
    result = [result, count_a + count_b].min
  end
  result
end
