...
- Chess.move_message("John", "Doe", "A1")
  ...
  find original: https://exercism.org/tracks/ruby/exercises/chess-game/
...
class ChessGame
  ...
  def self.move_message(first_name, last_name, square)
    f = square[0]
    r = square[1].to_i
    valid_square?(r, f) ? "#{nick_name(first_name, last_name)} moved to #{square}" : "#{nick_name(first_name, last_name)} attempted to move to #{square}, but that is not a valid square"
  end
end
